...
uint256 hashGenesisBlock("0xfddf202dc66674238c72ae1c934f135e3413a1b44bb043cbef18c0eb167e731b");
...
const string strMessageMagic = "gamecash Signed Message:\n";
...
{
    int64 nSubsidy = 550 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // gamecash: 1 days
static const int64 nTargetSpacing = 120; // gamecash: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal gamecash miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "gamecash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfddf202dc66674238c72ae1c934f135e3413a1b44bb043cbef18c0eb167e731b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Revolutionising the Game industry 24/09/2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506250878; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 467997;

        if (fTestNet)
        {
            block.nTime    = 1506250878;
            block.nNonce   = 467997;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc0a023c202c7963b92324fe1667071e0457e1bcd714fdbc12577e450efd6afde"));
...
string GetWarnings(string strFor)
{
    ...
    {
        nPriority = 2000;
        strStatusGCSH = strRPC = "WARNING: Displayed transactions may not be correct!  You may need to upgrade, or other nodes may need to upgrade.";
    }
    ...
    // Alerts
    {
        ...
        BOOST_FOREACH(PAIRTYPE(const uint256, CAlert)& item, mapAlerts)
        {
            ...
            if (alert.AppliesToMe() && alert.nPriority > nPriority)
            {
                ...
                strStatusGCSH = alert.strStatusGCSH;
            }
        }
    }

    if (strFor == "statusGCSH")
        return strStatusGCSH;
    else if (strFor == "rpc")
        return strRPC;
